...
public class GuiNovamenuMainMenu extends GuiNovamenuScreen {
	...
	public GuiNovamenuMainMenu() {
		createButton(I18n.func_135053_a("menu.singleplayer"));
		createButton(I18n.func_135053_a("menu.multiplayer"));
		createButton(I18n.func_135053_a("menu.options"));
		createButton("Mods");
		createButton(I18n.func_135053_a("menu.quit"));
	}
	...
	public void drawScreenForeground(int mouseX, int mouseY, float tick) {
		...
		this.mc.renderEngine.func_110577_a(new ResourceLocation("textures/gui/minecraft.png"));
