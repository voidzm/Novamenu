...
public class GuiNovamenuMultiplayerOptions extends GuiNovamenuScreen {
	...
	public void initGui() {
		...
		int i = 0;
		this.chatOptionsTitle = t.translateKey("options.chat.title");
		this.multiplayerOptionsTitle = t.translateKey("options.multiplayer.title");
		this.buttons.clear();
		...
		this.buttons.add(new GuiButtonTransparent(this, this.width / 2 - 100, this.height / 6 + 168, 200, 16, 10, t.translateKey("gui.done")));
	}
