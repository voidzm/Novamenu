...
public class GuiNovamenuDirectConnect extends GuiNovamenuScreen {
	...
	public void initGui() {
		...
		this.buttons.clear();
		this.buttons.add(new GuiButtonTransparent(this, this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 16, 0, I18n.getString("selectServer.select")));
	...
	public void drawScreenForeground(int par1, int par2, float par3) {
		...
		this.drawCenteredString(this.fontRenderer, I18n.getString("selectServer.direct"), this.width / 2, this.height / 4 - 60 + 20, 16777215);
